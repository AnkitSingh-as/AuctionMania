...
const Item = (props) => {
  ...
  // console.log("auctionitem", props.date);
  let sendBid = () => {
  ...
  // console.log(bidDate, "______seperator____" ,nowdate);

  let timeLeft = () => {
    const minute = 1000 * 60;
    const hour = minute * 60;
    const day = hour * 24;
    const bidDate = new Date(props.date);
    let now = new Date().getTime();
    let then = bidDate.getTime();
    difference = then - now;
  ...
  return (
    <div className="container my-0 px-0 d-flex justify-content-center align-items-center col-sm-6 col-lg-4 col-xl-3">
      <div className="card border-0">
        ...
        <div style={{ alignContent : "center",textAlign: "center", border:"dashed"}}>
